...
<head>
   <!-- Title and Discription start -->
	...
	<meta name="description"
		content="We couldn’t process your request. Please try again or contact us directly for immediate assistance.">
...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="tp-breadcrumb text-center">
                     ...
                     <h2 class="tp-breadcrumb-title">Failed</h2>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container pt-5 pb-4">
				<div class="img-size">
					<img class="imgg" src="assets/img/home/failed.png" />
				</div>
